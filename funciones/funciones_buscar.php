...
include(__DIR__ . '/../auth/validar_sesion.php'); // Solo para los que lo necesitan
...
switch($accion) {
    ...
    while ($row = mysqli_fetch_assoc($result)) {
        $listados[] = [
            // 'id' => $row['id_listado'], ❌ Eliminado porque ya no se muestra
            'empresa'   => $row['empresa'],
            'producto'  => $row['producto'],
            'fecha'     => $row['fecha'],
            'encargado' => $row['encargado'],
            'id_listado' => $row['id_listado'] // ✅ mantenido internamente para identificar el listado
        ];
    }
