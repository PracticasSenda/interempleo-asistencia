...
include(__DIR__ . '/../config/db.php'); // Conexión a la BD
    ...
    if (!filter_var($email, FILTER_VALIDATE_EMAIL)) {
        ...
        if (!checkdnsrr($domain, 'MX')) {
            ...
            if ($resultado && mysqli_num_rows($resultado) > 0) {
                ...
                $link = "http://localhost/interempleo-asistencia/auth/cambiar_contrasena.php?token=$token"; // // CAMBIAR URL si es otra
