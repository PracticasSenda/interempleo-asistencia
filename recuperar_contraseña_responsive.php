...
form { display: flex; flex-direction: column; gap: 15px; align-items: stretch; }
label { text-align: left; font-size: 16px; color: var(--color-texto); }
input[type="text"], input[type="email"] { padding: 12px; border: 1px solid var(--color-borde); border-radius: 4px; font-size: 16px; background-color: var(--color-input-bg); width: 100%; }
...
@media (max-width: 480px) {
    ...
    input[type="text"], input[type="email"] { font-size: 15px; padding: 10px; }
